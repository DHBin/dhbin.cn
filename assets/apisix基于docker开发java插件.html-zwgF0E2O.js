import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,e}from"./app-Ba--U_Af.js";const t={},p=e(`<h1 id="apisix基于docker开发java插件" tabindex="-1"><a class="header-anchor" href="#apisix基于docker开发java插件"><span>apisix基于docker开发java插件</span></a></h1><h2 id="环境准备" tabindex="-1"><a class="header-anchor" href="#环境准备"><span>环境准备</span></a></h2><p>apisix不支持windows，加上apisix的runner插件使用的协议不支持windows，所以需要在Linux环境下开发，有两个选择</p><ol><li>使用Linux服务器部署apisix，通过ssh远程开发</li><li>使用windows + wsl2，本地开发【推荐】</li></ol><p>两种方案IDEA都支持</p><p>使用docker快速搭建开发环境</p><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">git</span> clone https://github.com/apache/apisix-docker.git
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><p>在<code>example</code>文件夹中提供<code>docker-compose.yml</code>脚本，但需要简单地调整才能支持java runner的开发</p><p>1.修改<code>apisix_conf/config.yaml</code>，添加以下内容</p><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code><span class="token key atrule">ext-plugin</span><span class="token punctuation">:</span>
  <span class="token key atrule">path_for_test</span><span class="token punctuation">:</span> /tmp/runner.sock
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div></div></div><p>2.修改<code>docker-compose.yml</code>，在apisix的volumes中添加/tmp映射</p><div class="language-yaml line-numbers-mode" data-ext="yml" data-title="yml"><pre class="language-yaml"><code>  <span class="token key atrule">apisix</span><span class="token punctuation">:</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>就这样，一个简单的apisix java插件就完成了，从apisix配置路由插件，就可以把流量经过插件处理，下面是一个例子：</p><blockquote><p>创建upstream</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">--location</span> <span class="token parameter variable">--request</span> PUT <span class="token string">&#39;http://127.0.0.1:9180/apisix/admin/upstreams/1&#39;</span> <span class="token punctuation">\\</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><blockquote><p>创建router</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">--location</span> <span class="token parameter variable">--request</span> PUT <span class="token string">&#39;http://127.0.0.1:9180/apisix/admin/routes/1&#39;</span> <span class="token punctuation">\\</span>
<span class="token parameter variable">--header</span> <span class="token string">&#39;X-API-KEY: edd1c9f034335f136f87ad84b625c8f1&#39;</span> <span class="token punctuation">\\</span>
<span class="token parameter variable">--header</span> <span class="token string">&#39;Content-Type: application/json&#39;</span> <span class="token punctuation">\\</span>
<span class="token parameter variable">--data</span> <span class="token string">&#39;{
    &quot;methods&quot;: [
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>conf中的name需要与<code>PluginFilter#name</code>一致，apisix是这个名字找到对于的过滤器的</p><blockquote><p>测试</p></blockquote><div class="language-bash line-numbers-mode" data-ext="sh" data-title="sh"><pre class="language-bash"><code><span class="token function">curl</span> <span class="token parameter variable">--location</span> <span class="token parameter variable">--request</span> POST <span class="token string">&#39;http://127.0.0.1:9080/anything/get?foo1=bar1&amp;foo2=bar2&#39;</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h3 id="pluginfilter详解" tabindex="-1"><a class="header-anchor" href="#pluginfilter详解"><span>PluginFilter详解</span></a></h3><div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">interface</span> <span class="token class-name">PluginFilter</span> <span class="token punctuation">{</span>
    ...
    <span class="token punctuation">}</span>
<span class="token punctuation">}</span>
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><h3 id="生命周期" tabindex="-1"><a class="header-anchor" href="#生命周期"><span>生命周期</span></a></h3><ol><li>ext-plugin-pre-req</li><li>ext-plugin-post-req</li><li>ext-plugin-post-resp</li></ol><p><img src="https://cdn.dhbin.cn/202305290012195.png" alt="external-plugin"></p><h2 id="网关平替评估" tabindex="-1"><a class="header-anchor" href="#网关平替评估"><span>网关平替评估</span></a></h2><p>先说结果：<strong>支持平替gateway、zuul，但目前apisix提供的java插件没有达到生产级别，存在性能问题，需要定制开发</strong></p><p>问题1：<code>PluginFilter</code>写死了是否需要请求体、响应体，不能动态根据需要判断是否获取，当文件传输等大数据输出也获取body的话，导致严重的性能问题</p><p>问题2：apisix对于runner插件热更新能力较弱</p><h3 id="问题1解决方案" tabindex="-1"><a class="header-anchor" href="#问题1解决方案"><span>问题1解决方案</span></a></h3><p>需要解决<strong>问题1</strong>，先要了解apisix与java之间是怎么交互的，从下图知道apisix与runner的交互大致分为两步</p><ol><li>先转发http，不带body、nginx变量信息，如果不需要扩展信息直接返回</li><li>如果需要的话，直到获取要所有需要的扩展信息才返回</li></ol><p><img src="https://cdn.dhbin.cn/202305290012539.png" alt="apisix与runner交互图"></p><p>目前的问题就是，PluginFilter的三个方法请求，并没有传递request、response信息让用户动态判断是否需要获取控制信息</p><ul><li>requiredBody</li><li>requiredVars</li><li>requiredRespBody</li></ul><p><img src="https://cdn.dhbin.cn/202305290012112.png" alt="apisix-plugin-filter"></p><p>怎么解决？我们要在判断是否需要body的时候，能取到request/response的信息用作判断即可。</p><p>apisix的java runner插件实现是基于netty做的，以下是插件的几个关键Handler</p><ul><li>LoggingHandler：日志输出</li><li>PayloadEncoder：数据编码（bean -&gt; bytes）</li><li>BinaryProtocolDecoder：tcp粘包、粘包处理器（LengthFieldBasedFrameDecoder），协议切割</li><li>PayloadDecoder：数据解码（bytes -&gt; bean）</li><li><strong>PrepareConfHandler</strong>：处理<strong>RPC_PREPARE_CONF</strong>消息</li><li><strong>RpcCallHandler</strong>：处理<strong>RPC_EXTRA_INFO</strong>、<strong>RPC_HTTP_REQ_CALL</strong>、<strong>RPC_HTTP_RESP_CALL</strong>消息</li><li>ExceptionCaughtHandler：异常处理</li></ul><p>处理流程如下：</p><p><img src="https://cdn.dhbin.cn/202305290012478.png" alt=""></p><p>处理判断是否需要扩展信息的关键代码在<code>org.apache.apisix.plugin.runner.handler.RpcCallHandler#fetchExtraInfo</code>，如下</p><div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre class="language-java"><code><span class="token keyword">private</span> <span class="token keyword">void</span> <span class="token function">handleHttpReqCall</span><span class="token punctuation">(</span><span class="token class-name">ChannelHandlerContext</span> ctx<span class="token punctuation">,</span> <span class="token class-name">HttpRequest</span> request<span class="token punctuation">)</span> <span class="token punctuation">{</span>
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>重写<code>RpcCallHandler#fetchExtraInfo</code>方法的处理逻辑，判断是<code>ExtPluginFilter</code>执行控制的方法。</p><h3 id="问题2解决方案" tabindex="-1"><a class="header-anchor" href="#问题2解决方案"><span>问题2解决方案</span></a></h3><p>apisix提供的java热更新方案是监听文件夹内的java文件是否有变化，如果更新通过动态编译+自定义类加载器+BeanDefinitionRegistry，实现Filter的动态替换，但这个能力比较弱，同时也存在一些问题，比如</p><ul><li>更新需要添加依赖jar包是无法加载进去</li><li>替换bean不是原子操作存在间隙获取不到filter</li><li>带有缓存机制，目前版本没有清理缓存</li></ul><p>解决方案：</p><ul><li>监听改变事件、获取更新的版本信息，通过UrlClassLoader动态加载，并清理缓存。但替换bean不好解决，需要加锁</li></ul><p>解决方案二：</p><p>我们一般在k8s上部署，但需要更新版本时，重做镜像，通过k8s的能力滚动更新，不需要热更新的功能</p><h2 id="扩展" tabindex="-1"><a class="header-anchor" href="#扩展"><span>扩展</span></a></h2><h3 id="传输协议" tabindex="-1"><a class="header-anchor" href="#传输协议"><span>传输协议</span></a></h3><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>+-----------+------------+---------+
| 消息类型   |    数据长度  |   数据   |
+-----------+------------+---------+
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="https://cdn.dhbin.cn/202305290012598.png" alt=""></p><h2 id="测试方案" tabindex="-1"><a class="header-anchor" href="#测试方案"><span>测试方案</span></a></h2><ul><li>单元测试：junit + mockito</li><li>集成测试：testcontainer</li></ul>`,67),i=[p];function l(c,o){return s(),a("div",null,i)}const d=n(t,[["render",l],["__file","apisix基于docker开发java插件.html.vue"]]),k=JSON.parse('{"path":"/tech/java/apisix%E5%9F%BA%E4%BA%8Edocker%E5%BC%80%E5%8F%91java%E6%8F%92%E4%BB%B6.html","title":"apisix基于docker开发java插件","lang":"zh-CN","frontmatter":{"date":"2023-05-29T00:14:00.000Z","category":["Java"],"tag":["Apisix","Java"],"description":"apisix基于docker开发java插件 环境准备 apisix不支持windows，加上apisix的runner插件使用的协议不支持windows，所以需要在Linux环境下开发，有两个选择 使用Linux服务器部署apisix，通过ssh远程开发 使用windows + wsl2，本地开发【推荐】 两种方案IDEA都支持 使用docker快速...","head":[["meta",{"property":"og:url","content":"https://dhbin.cn/tech/java/apisix%E5%9F%BA%E4%BA%8Edocker%E5%BC%80%E5%8F%91java%E6%8F%92%E4%BB%B6.html"}],["meta",{"property":"og:site_name","content":"HB技术栈"}],["meta",{"property":"og:title","content":"apisix基于docker开发java插件"}],["meta",{"property":"og:description","content":"apisix基于docker开发java插件 环境准备 apisix不支持windows，加上apisix的runner插件使用的协议不支持windows，所以需要在Linux环境下开发，有两个选择 使用Linux服务器部署apisix，通过ssh远程开发 使用windows + wsl2，本地开发【推荐】 两种方案IDEA都支持 使用docker快速..."}],["meta",{"property":"og:type","content":"article"}],["meta",{"property":"og:image","content":"https://cdn.dhbin.cn/202305290012195.png"}],["meta",{"property":"og:locale","content":"zh-CN"}],["meta",{"property":"og:updated_time","content":"2023-05-28T16:21:09.000Z"}],["meta",{"property":"article:author","content":"DHB"}],["meta",{"property":"article:tag","content":"Apisix"}],["meta",{"property":"article:tag","content":"Java"}],["meta",{"property":"article:published_time","content":"2023-05-29T00:14:00.000Z"}],["meta",{"property":"article:modified_time","content":"2023-05-28T16:21:09.000Z"}],["script",{"type":"application/ld+json"},"{\\"@context\\":\\"https://schema.org\\",\\"@type\\":\\"Article\\",\\"headline\\":\\"apisix基于docker开发java插件\\",\\"image\\":[\\"https://cdn.dhbin.cn/202305290012195.png\\",\\"https://cdn.dhbin.cn/202305290012539.png\\",\\"https://cdn.dhbin.cn/202305290012112.png\\",\\"https://cdn.dhbin.cn/202305290012478.png\\",\\"https://cdn.dhbin.cn/202305290012598.png\\"],\\"datePublished\\":\\"2023-05-29T00:14:00.000Z\\",\\"dateModified\\":\\"2023-05-28T16:21:09.000Z\\",\\"author\\":[{\\"@type\\":\\"Person\\",\\"name\\":\\"DHB\\",\\"url\\":\\"https://dhbin.cn\\"}]}"]]},"headers":[{"level":2,"title":"环境准备","slug":"环境准备","link":"#环境准备","children":[]},{"level":2,"title":"插件开发","slug":"插件开发","link":"#插件开发","children":[{"level":3,"title":"PluginFilter详解","slug":"pluginfilter详解","link":"#pluginfilter详解","children":[]},{"level":3,"title":"生命周期","slug":"生命周期","link":"#生命周期","children":[]}]},{"level":2,"title":"网关平替评估","slug":"网关平替评估","link":"#网关平替评估","children":[{"level":3,"title":"问题1解决方案","slug":"问题1解决方案","link":"#问题1解决方案","children":[]},{"level":3,"title":"问题2解决方案","slug":"问题2解决方案","link":"#问题2解决方案","children":[]}]},{"level":2,"title":"扩展","slug":"扩展","link":"#扩展","children":[{"level":3,"title":"传输协议","slug":"传输协议","link":"#传输协议","children":[]}]},{"level":2,"title":"测试方案","slug":"测试方案","link":"#测试方案","children":[]}],"git":{"createdTime":1685290869000,"updatedTime":1685290869000,"contributors":[{"name":"dhb","email":"xx158@qq.com","commits":1}]},"readingTime":{"minutes":7.29,"words":2188},"localizedDate":"2023年5月29日","excerpt":"\\n<h2>环境准备</h2>\\n<p>apisix不支持windows，加上apisix的runner插件使用的协议不支持windows，所以需要在Linux环境下开发，有两个选择</p>\\n<ol>\\n<li>使用Linux服务器部署apisix，通过ssh远程开发</li>\\n<li>使用windows + wsl2，本地开发【推荐】</li>\\n</ol>\\n<p>两种方案IDEA都支持</p>\\n<p>使用docker快速搭建开发环境</p>\\n<div class=\\"language-bash\\" data-ext=\\"sh\\" data-title=\\"sh\\"><pre class=\\"language-bash\\"><code><span class=\\"token function\\">git</span> clone https://github.com/apache/apisix-docker.git\\n</code></pre></div>","autoDesc":true}');export{d as comp,k as data};
