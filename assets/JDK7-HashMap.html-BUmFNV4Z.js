import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as s,c as a,e}from"./app-Ba--U_Af.js";const t={},p=e(`<h1 id="jdk7-hashmap" tabindex="-1"><a class="header-anchor" href="#jdk7-hashmap"><span>JDK7-HashMap</span></a></h1><h1 id="前言" tabindex="-1"><a class="header-anchor" href="#前言"><span>前言</span></a></h1><p>现在一般都JDK8了，为什么还要说JDK7呢。因为JDK7和JDK8的hashmap实现不一样，JDK7是用数组+链表实现的，而JDK8是红黑树。学习都是个慢慢渐进的过程。</p><h1 id="实现" tabindex="-1"><a class="header-anchor" href="#实现"><span>实现</span></a></h1><p>时间复杂度：</p><table><thead><tr><th></th><th>读取</th><th>插入</th><th>删除</th></tr></thead><tbody><tr><td>数组</td><td>O(1)</td><td>O(n)</td><td>O(n)</td></tr><tr><td>链表</td><td>O(n)</td><td>O(1)</td><td>O(1)</td></tr></tbody></table><p>上面提到JDK7是用数组+链表实现的，为什么这样做呢？我们知道数组读取速度快，插入慢，而链表读取慢，插入快，hashmap就是充分利用了数组读取快和链表插入快的特点。数组存着元素的下标，元素插入链表中。那么下标怎么生成呢，hashmap嘛，那肯定是和hashcode有关系，我们生成hashcode看看是啥样的。</p><div class="language-java line-numbers-mode" data-ext="java" data-title="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">Main</span> <span class="token punctuation">{</span>
