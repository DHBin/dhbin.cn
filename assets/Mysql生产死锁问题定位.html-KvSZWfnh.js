import{_ as e}from"./plugin-vue_export-helper-DlAUqK2U.js";import{o as n,c as s,e as i}from"./app-Ba--U_Af.js";const a={},t=i(`<h1 id="mysql生产死锁问题定位" tabindex="-1"><a class="header-anchor" href="#mysql生产死锁问题定位"><span>Mysql生产死锁问题定位</span></a></h1><p>生产上一个消费mq消息的服务出现了死锁问题，通过命令获取到的mysql日志如下：</p><div class="language-text line-numbers-mode" data-ext="text" data-title="text"><pre class="language-text"><code>=====================================
